...
const DescriptionSentAvg = () => {
  return (
    <div>
      <Typography variant="body2" sx={{ fontFamily: 'Poppins', fontWeight: 300 }}>
              <b>SENTAVG</b> est un modèle neuronal à base de <b>LSTM</b> (Long Short Term Memory)
              qui évalue la cohérence d'un discours à travers les similarités
              cosines entre <b>ses phrases</b>, en modélisant ainsi la parenté sémantique entre elles
      </Typography>
      <br/>
...
export default DescriptionSentAvg